...
let BookDetails = ({ ocClickForBooksDetails , ocClickForEditBook}) => {
    ...
    <div className="overlay">
        <div className="book-details the-service">
            <div className="header-collection">
                ...
                }}><FontAwesomeIcon icon={faArrowLeft} size="2xl" className="back-icon"/></Link>
            </div>
                ...
                <div className="collection-of">
                    <div className="flex-collection">
                        ...
                        <p className="created-date">
                            ...
                            {the_book.created_date || "لا يوجد"}
                        </p>
                        <p className="updated-date">
                            <p className="detail-data">تاريخ التعديل</p>
                            {the_book.updated_date || "لا يوجد"}
                        </p> 
                    </div>
                    <button onClick={ocClickForEditBook} className="edit-book">تعديل بيانات الكتاب</button>      
                </div>}
            </div>
        </div>
    </div>
