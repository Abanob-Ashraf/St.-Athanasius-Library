...
let SearchedBooks = ({ ocClickForSearchedBooks , ocClickForBooksDetails }) => {
    const books = JSON.parse(sessionStorage.getItem("books"));
    let booksMaping = books.map((e)=>{
        return (
            <tr onClick={() => {
                ocClickForSearchedBooks();
    ...
    <div className="overlay">
        <div className="searched-books the-service">
            <div className="header-collection">
                ...
                }}><FontAwesomeIcon icon={faClose} size="2xl" className="close-icon"/></Link>
            </div>
