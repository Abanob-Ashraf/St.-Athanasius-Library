...
export const CREATEUSER =
  'INSERT INTO users (first_name, last_name, email, password, phone_number, admin_flag, user_status, created_date, updated_date) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id, first_name, last_name, email, admin_flag, user_status, updated_date, created_date'

//getAll Users
export const GETMANYUSERS =
  'SELECT id, first_name, last_name, email, phone_number, admin_flag, user_status, created_date, updated_date FROM users'
...
export const SEARCHFORUSER =
  'SELECT id, first_name, last_name, email, phone_number, admin_flag, user_status, created_date, updated_date FROM users WHERE first_name=($1) OR last_name=($2) OR email=($3)'
...
export const AUTHANTICATE2 =
  'SELECT id, first_name, last_name, email, phone_number, admin_flag, user_status FROM users WHERE email=($1)'
